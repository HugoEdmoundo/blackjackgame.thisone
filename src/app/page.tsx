  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1628] via-[#101d35] to-[#162a4a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <Sparkles size={96} className="absolute top-20 left-[10%] opacity-[0.04] rotate-12 select-none text-gold-400" />
        <Sparkles size={80} className="absolute bottom-20 right-[10%] opacity-[0.04] -rotate-12 select-none text-gold-400" />
        <Sparkles size={64} className="absolute top-1/3 right-[8%] opacity-[0.03] rotate-45 select-none text-gold-400" />
        <Sparkles size={56} className="absolute bottom-1/3 left-[8%] opacity-[0.03] -rotate-45 select-none text-gold-400" />
      </div>
